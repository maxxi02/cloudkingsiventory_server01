...
const verifyEmailTemplate = (url, brandColor = '#000000') => ({
    subject: 'Confirm your Cloud Kings account',
...
const passwordResetTemplate = (url, brandColor = '#000000') => ({
    ...
    html: `
      <html><head><style>
        ...
        <div class="container">
          <div class="header">Cloud Kings</div>
          <div class="content">
